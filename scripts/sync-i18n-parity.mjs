...
const BG_FROM_EN = {
  ...
  "admin.domains.errors.reserved_domain": "Не можеш да използваш домейна на платформата Nestio.",
  "admin.domains.nestioSubdomain": "Nestio поддомейн (по подразбиране, винаги активен)",
  "admin.domains.nestioSubdomainHint": "Публичен сайт, календар за резервации и админ.",
  ...
  "admin.domains.kinds.custom_public": "Собствен — сайт + резервации; админ на Nestio",
  "admin.domains.kinds.hospira_subdomain": "Nestio поддомейн (пълно приложение)",
  "admin.domains.markVerified": "Маркирай като верифициран (след DNS + Vercel)",
  "admin.domains.openSite": "Отвори сайта",
  "admin.domains.pageDescription": "Nestio поддомейн и собствени домейни (всички режими).",
  ...
  "admin.pages.buildings.listTitle": "Сгради — Nestio",
  ...
  "admin.pages.settings.domainsSubtitle": "Nestio поддомейн и собствен домейн",
