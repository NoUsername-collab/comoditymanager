...
export const CHECKIN_ROW_SELECT =
  "id, tenant_id, booking_id, type, status, checked_in_at, checked_in_by, payment_status, payment_amount_paid, deposit_amount, key_handed, keys_handed_rooms, flags, notes, created_at";
