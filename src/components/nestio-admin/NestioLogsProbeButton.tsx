...
import { probeNestioLogsErrorAction } from "@/app/[locale]/nestio-admin/(panel)/actions/logs-actions";
import { Link } from "@/i18n/navigation";

export function NestioLogsProbeButton() {
  ...
  return (
    <div className="flex flex-col items-end gap-2">
      <div className="flex flex-wrap items-center justify-end gap-2">
        <Link
          href="/nestio-admin/logs?throw=page"
        ...
        <button
          ...
          onClick={() => {
            ...
            startTransition(async () => {
              try {
                await probeNestioLogsErrorAction();
                setProbeResult({
                  ok: false,
                  message:
                ...
                console.error("[nestio-logs-probe]", error);
                setProbeResult({
                  ok: true,
                  logWritten: true,
                  message,
