import { ACTION_COLOR } from "@/lib/nestio-admin/log-styles";
import { TenantLogFilter } from "@/components/nestio-admin/TenantLogFilter";
import type { NestioLogFilterOption } from "@/services/nestio-logs-page-data";
...
export function PlatformActivityLogTable({
  ...
  return (
    <div className="hospira-log-section rounded-lg border border-neutral-800 bg-neutral-900 p-3.5">
      <div className="hospira-log-section__head mb-2 flex items-center justify-between gap-2">
      ...
      <ul className="hospira-log-cards max-h-[min(70dvh,36rem)] space-y-2 overflow-y-auto">
        {logs.map((log) => (
          <li
            key={log.id}
            className="hospira-log-card rounded-md border border-neutral-800 bg-neutral-800/40 px-3 py-2.5"
          >
      ...
      <div className="hospira-log-table-desktop nestio-logs-table-wrap max-h-[600px] overflow-y-auto">
