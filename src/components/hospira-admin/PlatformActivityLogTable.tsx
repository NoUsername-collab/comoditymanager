import { ACTION_COLOR } from "@/lib/hospira-admin/log-styles";
import { TenantLogFilter } from "@/components/hospira-admin/TenantLogFilter";
import type { HospiraLogFilterOption } from "@/services/hospira-logs-page-data";
...
export function PlatformActivityLogTable({
  ...
  return (
    <div className="hospira-log-section rounded-lg border border-neutral-800 bg-neutral-900 p-3.5">
      ...
      <div className="hospira-log-table-desktop hospira-logs-table-wrap max-h-[600px] overflow-y-auto">
