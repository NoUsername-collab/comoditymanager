...
import { revalidatePlatformAdminCacheAction } from "@/app/[locale]/hospira-admin/(panel)/actions/dev-actions";
import type { MigrationMarker } from "@/lib/hospira-admin/migration-audit";
...
export function PlatformDevTools({
  ...
  const t = useTranslations("hospiraAdmin.devTools");
