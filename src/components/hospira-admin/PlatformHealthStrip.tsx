...
import type { PlatformInfraHealth } from "@/lib/hospira-admin/platform-health";
...
export async function PlatformHealthStrip({
  ...
  const t = await getTranslations("hospiraAdmin.health");
      ...
      >
        ...
        <p className="mt-1 text-xs text-neutral-400">
          {t("domainsSummary", {
            ...
            subdomains: health.domains.hospiraSubdomains,
