...
export function TodayBoardSection({ board }: { board: TodayBoard }) {
    ...
    >
      <section className="admin-today-board">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h2 className="text-lg font-semibold text-zinc-900">Azi</h2>
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-3">
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wide text-emerald-800">
              Check-in azi ({board.checkInTime})
            </h3>
            <div className="mt-3">
              <GuestList items={board.arrivals} empty="Nicio sosire confirmată." />
            </div>
          </div>
          <div>
            <h3 className="text-xs font-bold uppercase tracking-wide text-amber-800">
              Check-out azi ({board.checkOutTime})
            </h3>
            <div className="mt-3">
              <GuestList
                items={board.departures}
                empty="Nicio plecare confirmată."
              />
            </div>
          </div>
          <div>
            ...
            <p className="mt-1 text-xs text-zinc-500">
              După plecarea oaspeților, înainte de următorul check-in.
            </p>
