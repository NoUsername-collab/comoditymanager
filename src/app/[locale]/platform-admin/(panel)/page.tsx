    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-3">
        <Link
          ...
          className="platform-dashboard__cta inline-flex min-h-[var(--ml-touch-min,2.75rem)] items-center justify-center gap-2 rounded-md bg-white px-4 py-2 text-sm font-medium text-neutral-900 transition-colors hover:bg-neutral-200"
        >
          {t("viewAllTenants")} →
        </Link>
        <Link
