...
export default function PlatformLogsError({
  error,
  reset,
}: {
  ...
  const t = useTranslations("platformAdmin.error");
  const logsT = useTranslations("platformAdmin.logs.error");

  useEffect(() => {
    console.error("[platform-admin/logs]", {
      name: error.name,
