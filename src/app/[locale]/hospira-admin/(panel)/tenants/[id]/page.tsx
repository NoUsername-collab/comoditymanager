...
import { TenantQuickLinks } from "@/components/hospira-admin/TenantQuickLinks";
import { TenantHealthBadge } from "@/components/hospira-admin/TenantHealthBadge";
import { TenantDomainsPanel } from "@/components/hospira-admin/TenantDomainsPanel";
import { TenantSupportTools } from "@/components/hospira-admin/TenantSupportTools";
import {
  TenantActivityPanel,
  TenantSiteLinksPanel,
} from "@/components/hospira-admin/TenantDetailExtras";
...
export default async function TenantDetailPage({
  ...
  const [tenant, health, domains, activity, t] = await Promise.all([
    ...
    getTranslations("hospiraAdmin.tenantDetail"),
  ]);
