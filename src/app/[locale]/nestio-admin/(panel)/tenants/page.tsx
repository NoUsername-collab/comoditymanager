...
import { NestioTenantsMobileCards } from "@/components/nestio-admin/NestioTenantsMobileCards";
...
export default async function TenantsListPage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <NestioTenantsMobileCards tenants={tenants} />
            ...
            {tenants.map((t) => (
              ...
              >
                ...
                <td className="px-3 py-2 text-right">
                  <Link
                    href={`/nestio-admin/tenants/${t.id}`}
