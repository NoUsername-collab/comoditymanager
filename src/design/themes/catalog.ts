...
export const DESIGN_THEMES: Record<DesignThemeId, DesignThemeDefinition> = {
  ...
  pearl: {
    ...
    public: {
      ...
      card: "#ffffff",
      cardElevated: "#f3ede4",
      border: "color-mix(in srgb, #6e4538 18%, #ddd0c8)",
      heroGlow: "rgba(110, 69, 56, 0.15)",
      fontDisplay: DISPLAY,
      logoFilter: "none",
      logoFilterHover: "drop-shadow(0 8px 20px rgba(110, 69, 56, 0.22))",
      link: "#5a372d",
      focusRing: "#6e4538",
    },
    admin: {
      day: {
        ...
        accent: "#6e4538",
        accentHover: "#5a372d",
        accentMuted: "color-mix(in srgb, #6e4538 14%, #faf7f2)",
      },
      night: {
        bg: "#150f0b",
        surface: "#1e1612",
  ...
  forest: {
    id: "forest",
    name: "Forest",
    description: "Daylight lodge — moss paper, forest-green accent.",
    public: {
      bg: "#eef4ea",
      fg: "#132016",
      muted: "#3d5340",
      accent: "#2f6a38",
      accentFg: "#f6fff6",
      headerBg: "color-mix(in srgb, #eef4ea 94%, transparent)",
      card: "#ffffff",
      cardElevated: "#e4ede0",
      border: "color-mix(in srgb, #2f6a38 16%, #c5d4bc)",
      heroGlow: "rgba(47, 106, 56, 0.14)",
      fontDisplay: DISPLAY,
      logoFilter: "none",
      logoFilterHover: "drop-shadow(0 8px 18px rgba(47, 106, 56, 0.18))",
      link: "#1f4e28",
      focusRing: "#2f6a38",
    },
    admin: {
